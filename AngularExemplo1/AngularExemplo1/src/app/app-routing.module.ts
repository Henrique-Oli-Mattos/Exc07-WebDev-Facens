...
import { CalcularMediaFacensComponent } from './calcular-media-facens/calcular-media-facens.component';

const routes: Routes = [
  { path: '', redirectTo: '/calculadora', pathMatch: 'full' },
  { path: 'calculadoras', redirectTo: '/calculadora', pathMatch: 'full' },
  { path: 'calcula-media-facens', component: CalcularMediaFacensComponent},
